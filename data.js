...
const PROJECTS = [
  { code:'a01', title:'REFUGE BALLAND', typo:'LOGEMENT PRIVÉ', lieu:'Ikast — DANEMARK', annee:'2025',
  ...
  { code:'a02', title:'VILLA CLAIRETTES', typo:'LOGEMENT PRIVÉ', lieu:'Saint-Raphaël — FRANCE', annee:'2023',
  ...
  { code:'a03', title:'VILLA DEROUET', typo:'LOGEMENT PRIVÉ', lieu:'Orgeval — FRANCE', annee:'2020',
  ...
  { code:'a04', title:'LOFT DES GARDES', typo:'LOGEMENT PRIVÉ', lieu:'Meudon — FRANCE', annee:'2026',
  ...
  { code:'a05', title:'ÉCURIE MOLLET', typo:'LOGEMENT PRIVÉ — PATRIMOINE', lieu:'Antony — FRANCE', annee:'2024',
  ...
  { code:'a06', title:'MAISON BOBILLOT', typo:'LOGEMENT PRIVÉ', lieu:'Paris 13e — FRANCE', annee:'2025',
  ...
  { code:'a07', title:'ÉCOLE HAXO', typo:'ÉTABLISSEMENT SCOLAIRE', lieu:'Paris 20e — FRANCE', annee:'2022',
    desc:"Le projet s'articule autour d'un socle affirmé qui permet l'accès au bâtiment, surmonté d'un volume surélevé qui le met en valeur tout en protégeant les enfants de l'effervescence de la rue.\n\nEnfin, les espaces extérieurs (ouvertures, terrasses et toiture) agissent comme des filtres. Ils mettent en scène et maîtrisent avec soin la transition entre le cocon protecteur de l'école et le monde extérieur.",
  ...
  { code:'a08', title:'BRASSERIE B', typo:'ERP — RESTAURANT', lieu:'Clamart — FRANCE', annee:'2024',
    desc:"Idéalement située sur la place de la mairie à Clamart, cette brasserie a été pensée comme un hommage à la mémoire de la commune.\n\nEn transposant subtilement l'univers minéral des anciennes carrières de grès et la riche tradition viticole locale, nous y avons façonné une atmosphère intemporelle, qui vient réinventer les codes de la brasserie contemporaine.",
  ...
  { code:'a09', title:'MAISON GAMBLIN', typo:'LOGEMENT PRIVÉ', lieu:'Paris 17e — FRANCE', annee:'2022',
  ...
  { code:'a10', title:'LOFT BERTHIER', typo:'LOGEMENT PRIVÉ', lieu:'Paris 17e — FRANCE', annee:'2021',
  ...
  { code:'a11', title:'DIGUE DE PANDOP', typo:'INFRASTRUCTURE', lieu:'Koumac — NOUVELLE-CALÉDONIE', annee:'2019',
  ...
  { code:'a12', title:'CASA MECA', typo:"HABITAT D'URGENCE", lieu:'Boquerón — PARAGUAY', annee:'2020',
    desc:"Imaginé pour des personnes en situation d'urgence, au Paraguay, nous avons conçu la Casa Meca sur une échelle de temporalité adaptée et adaptable à toutes ces populations.\n\nModularité, évolutivité, ergonomie, écologie caractérisent le projet. Sa structure simplifiée et répétitive permet une mise en œuvre rapide par un petit nombre de personnes.",
  ...
  { code:'i01', title:'REFUGE BUÉ', typo:'LOGEMENT PRIVÉ', lieu:'Choisy-le-Roi — FRANCE', annee:'2023',
  ...
  { code:'i02', title:'ESCALIER VELA', typo:'LOGEMENT PRIVÉ', lieu:'Créteil — FRANCE', annee:'2020',
  ...
  { code:'i03', title:'CO-WORKING HENRY V', typo:'TERTIAIRE / BUREAU', lieu:'Paris 4e — FRANCE', annee:'2022',
  ...
  { code:'p01', title:'JARDINS COLLECTIFS MONTIGNY', typo:'PAYSAGE — ÉQUIPEMENT PUBLIC', lieu:'Montigny — FRANCE', annee:'2019',
  ...
  { code:'p02', title:'JARDINS SUSPENDUS', typo:'PAYSAGE', lieu:'Paris 4e — FRANCE', annee:'2024',
